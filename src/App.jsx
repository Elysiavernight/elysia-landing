...
const MemberCard = ({
    ...
    >
        ...
        {/* Content Section */}
        <div
            className={`flex-1 flex flex-col ${isReversed
        ...
        >
            ...
            {/* Tech Stacks */}
            <div
                className={`flex flex-wrap gap-4 mb-8 ${isReversed ? "md:justify-end" : "md:justify-start"
                    } justify-center`}
            >
                {tech.map((item, index) => (
                    <motion.span
            ...
            <div className="mb-6">
                ...
                <div
                    className={`flex flex-wrap gap-x-6 gap-y-4 ${isReversed ? "md:flex-row-reverse" : "md:flex-row"
                        } justify-center`}
                >
            ...
            <div className="mb-11 w-full">
                ...
                <div
                    className={`flex flex-wrap gap-6 ${isReversed ? "md:justify-end" : "md:justify-start"
                        } justify-center`}
                >
                        ...
                        const content = (
                            ...
                            >
                                <img
                                    src={game.logo}
                                    alt={game.name}
                                    className={`w-10 h-10 object-contain ${game.link
    ...
    const members = [
        ...
        },
        {
            ...
            games: [
                ...
                { name: "Mahjong Soul", logo: mahjong, link: "https://amae-koromo.sapk.ch/player/123080172/9" },
                { name: "Minecraft", logo: mcLogo },
                { name: "PUBGM", logo: pubgm },
