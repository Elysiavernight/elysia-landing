    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-2 group pointer-events-auto">
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md px-3 py-1 rounded-lg border border-pink-100 dark:border-pink-900/50 shadow-sm opacity-0 group-hover:opacity-100 transition-opacity">
        <span className="text-[10px] font-black text-pink-500 uppercase tracking-tighter">
          HOYOMIX - Ripples of Past Reverie
        </span>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-6 space-y-24 pb-32">
        ...
        >
          <div className="bg-white/70 dark:bg-white/5 backdrop-blur-xl border-2 border-pink-100 dark:border-pink-900/50 p-10 rounded-[3rem] shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black text-pink-500 mb-6 text-center">
              ...
              <br />
              <br />
              "Let humanity proof to you that even the breeding ground of
              destruction, can bloom with gentle flowers of Love"
              <br />
            ...
            <p className="text-xl text-gray-500 dark:text-gray-400 leading-relaxed italic">
              Hi, I am Rycene, Also Known as Wolfie. I'm 20 years old with
              Specialty in Backend Development. Started Programming With C now
              im Tackling Rust like it's An HSR MOC-12 Challenge. My Favorite
              Stack to use is ElysiaJS Paired with React(vite) and Zig as my
              favorite low-level language.
              <br />
              <br />
              Personally, For me, Cyrene is a role-model for me as she always
              reminds me that even in dire circumstances, there are hope. If you
              can't fulfill it today, Send it to tomorrow.
            </p>
          </div>
        </motion.section>
        ...
        <section className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            />
            <ProjectCard
              title="HSR-lang-patcher"
              description="A terminal program to patch HSR client language based on zig"
              githubLink="https://github.com/SilverWolfiee/animegame-lang-patcher"
              tags={["Zig", "HSR", "low level"]}
            />
            <ProjectCard
              title="Hello, World!"
        ...
        <section className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <a
                href="https://github.com/SilverWolfiee"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/silverwolfzzz/"
                target="_blank"
                className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl hover:bg-pink-500 hover:text-white transition-all group"
              >
              ...
              <a
                href="https://www.tiktok.com/@silverwolfieeee"
                target="_blank"
                className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl hover:bg-pink-500 hover:text-white transition-all group"
              >
              ...
              <a
                href="https://www.tiktok.com/@fuchsiashark"
                target="_blank"
                className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl hover:bg-pink-500 hover:text-white transition-all group"
              >
                <FaTiktok className="text-xl" />
              ...
              <a
                href="https://www.youtube.com/@SilverWolfzz"
                target="_blank"
                className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl hover:bg-pink-500 hover:text-white transition-all group"
              >
